...
|22|Написать скрипт, который выполнит автоматически пункты 3, 4, 5, 6, 7, 8, 13|[Ссылка на файл](https://github.com/ArtiomMironov/Terminal/blob/main/script.sh) **|
...
Флаг `-h` команды `grep` используется для скрытия имен файлов при поиске совпадений в нескольких файлах.
